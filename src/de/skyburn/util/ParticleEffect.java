package de.skyburn.util;

import de.skyburn.util.ReflectionUtils.PackageType;
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				...
				Class<?> packetClass = PackageType.MINECRAFT_SERVER.getClass(version < 7 ? "PacketPlayOutWorldParticles" : "Packet63WorldParticles");
